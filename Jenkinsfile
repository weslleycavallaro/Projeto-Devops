pipeline {
    ...
    post {
        ...
        success {
            ...
            sh '''
            curl -X POST -H 'Content-type: application/json' --data '{"text":"💪 Chuck Norris aprova seu pipeline DevSecOps!"}' https://hooks.slack.com/services/url
            '''
        }
        ...
        failure {
            ...
            sh '''
            curl -X POST -H 'Content-type: application/json' --data '{"text":"❌ Build falhou, mas Chuck Norris nunca desiste!"}' https://hooks.slack.com/services/url
            '''
        ...
        unstable {
            ...
            sh '''
            curl -X POST -H 'Content-type: application/json' --data '{"text":"⚠️ Build instável - Chuck Norris está monitorando"}' https://hooks.slack.com/services/url
            '''        
        }
    }
}